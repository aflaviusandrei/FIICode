<?php $__env->startSection('content'); ?>
            ...
            <div class="ui segment">
                <table class="ui celled striped structured table">
                    ...
                    <tr>
                        <td>Inscrieri</td>
                        <td>
                            19 Februarie 2018 - 16 Martie 2018
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>Algoritmică</td>
                        <td>
                            Etapa I: 18 Martie la 17:00<br />
                            Etapa II: 3 Aprilie la 17:00<br />
                            Etapa III: 22 Aprilie la 17:00<br />
                        </td>
                        <td>
    ...
    <script>
        ...
        window.onload=function(){
            var cdown1 = new CDown("Înscrierile au început!");
            cdown1.add(new Date(2017,0,17,0,16,8), "countbox1");

            var cdown2 = new CDown("Etapa tehnologiior web e în desfășurare.");
            cdown2.add(new Date(2017,2,26,18,0,0), "countbox2");

            var cdown3 = new CDown("Etapa de game development e în desfășurare.");
            cdown3.add(new Date(2017,2,26,18,0,0), "countbox3");

            var cdown4 = new CDown("Etapa de algoritmică e în desfășurare.");
            cdown4.add(new Date(2017,2,26,18,0,0), "countbox4");

            var cdown5 = new CDown("Rezultatele vor fi afișate în curând.");
            cdown5.add(new Date(2017,3,30,18,0,0), "countbox5");

            var cdown6 = new CDown("Etapa finală a început :). Good luck!");
