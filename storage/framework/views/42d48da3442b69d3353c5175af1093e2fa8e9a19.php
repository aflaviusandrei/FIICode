...
<head>
    ...
    <!--link media="all" type="text/css" rel="stylesheet" href="<?php echo e(asset("packages/zofe/rapyd/assets/redactor/css/redactor.css")); ?>"-->
    ...
    <!--link media="all" type="text/css" rel="stylesheet" href="<?php echo e(asset("packages/serverfireteam/rapyd-laravel/assets/colorpicker/css/bootstrap-colorpicker.min.css")); ?>" -->

    <title><?php echo e(isset($title) ? $title : 'Panel'); ?></title>
    <!-- compiled styles -->
...
<body class="<?php echo $__env->yieldContent('bodyClass'); ?>">
    ...
    <!--script src="<?php echo e(asset("packages/zofe/rapyd/assets/redactor/jquery.browser.min.js")); ?>"></script-->
    <!--script src="<?php echo e(asset("packages/zofe/rapyd/assets/redactor/redactor.min.js")); ?>"></script-->
    ...
    <!--script src="<?php echo e(asset("packages/serverfireteam/rapyd-laravel/assets/colorpicker/js/bootstrap-colorpicker.min.js")); ?>"></script-->
