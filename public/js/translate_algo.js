function eng_algo() {
	...
	document.getElementById("algodesc4").innerHTML = "At the final round, the first 25 participants from Romania and Republic of Moldova and the first 5 from the other countries will qualify.";
	...
	document.getElementById("l61").innerHTML = "1st place: 40% out of the available total, prize: 200€"
	document.getElementById("l62").innerHTML = "2nd place: 25% out of the available total, prize: 125€"
	document.getElementById("l63").innerHTML = "3rd place: 15% out of the available total, prize: 75€"
