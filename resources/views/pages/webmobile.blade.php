...
@section('content')
    <section id="content">
        <div class="ui container">
            <div class="head"><i class="icon code"></i> Web/Mobile <div class="green"></div><div class="red"></div></div>
            <div class="ui segment">
                ...
                <div class="col-xs-12 ">
                            ...
                            <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                ...
                                <br><center><h2>FII Code - Web/Mobile</h2>
	<br>
	Aceasta pagina este dedicata sectiunii de web/mobile din cadrul concursului FII Code. Aici se vor posta informatiile utile participantilor la aceasta sectiune.

	<br>
	<br>
    <b>Calendar proba Web/Mobile</b><br><br>
		...
		Runda Finala - 6 aprilie 2019		<br>
                                ...
                                <br><center><h2><strong>Regulamentul secțiunii WEB/Mobile</strong></h2></center><br>
                ...
                <p>Participarea la concurs se face în echipe formate dintr-un număr de 2-3 concurenți, înscriși la momentul începerii concursului la un liceu sau facultate din România, indiferent de naționalitate. În cazul în care anumiți concurenți care doresc să participe nu reușesc să-și formeze o echipă, se va organiza o sesiune, în continuă comunicare cu aceștia, prin care se vor forma, de comun acord, noi echipe. În acest caz, nu este garantată includerea în echipe a tuturor acestora, acest lucru putând depinde de mai mulți factori. De asemenea, între echipele generate din proprie inițiativă și cele create în această sesiune, nu va exista nicio diferență în modul de punctare, fiind asumate de către toți participanții la această secțiune aceleași criterii de jurizare.</p>
                ...
                <p>Ordonarea echipelor pentru clasamentul de calificare la runda finală ține cont doar de rezultatul din etapa online (descrescător).</p>
                ...
                <ul>
                    <li>Premiul I: 50% din totalul disponibil,</li>
                    <li>Premiul al II-lea: 30% din totalul disponibil,</li>
                    <li>Premiul al III-lea: 20% din totalul disponibil,</li>
                ...
                <p>Coordonatorii concursului își rezervă dreptul de a modifica fără notificare prealabilă acest regulament. Asigurăm participanții că nu se vor realiza modificări ale regulamentului în ce privește datele tehnice în perioada unei runde.</p>
                                ...
                                <div class="tab-pane fade" id="nav-rez" role="tabpanel" aria-labelledby="nav-rez-tab">
                                    <br><center><h2><strong>Teme din editia 2018:</strong></h2><br><br>
                                    <p>
                                    ...
                                    <br><b>Clasament:</b><br><br>
                                    
                                        1.<b>Discode</b><br>
                                        2.<b>CVA Team</b><br>
                                        3.<b>DMSL</b><br>
                                        4.<b>In a nutshell</b><br>
                                        5.<b>Codeleign</b><br>
                                        6.<b>Rufus</b> -Necalificata pentru runda finala.<br>
                                        7.<b>Blank</b> -Necalificata pentru runda finala.<br>
