...
CREATE TABLE `users` (
  ...
  `csacademy` varchar(100) NOT NULL,
  `oras` varchar(100) NOT NULL,
  `varsta` int(11) NOT NULL,
  `telefon` varchar(20) NOT NULL,
  `facebook` varchar(255) NOT NULL,
  `scoala` varchar(255) NOT NULL,
  `marime_tricou` varchar(20) NOT NULL,
  `web` tinyint(4) NOT NULL,
  `terms_and_conditions1` tinyint(4) NOT NULL,
  `terms_and_conditions2` tinyint(4) NOT NULL,  
  ...
  `marime_tricou2` varchar(20) NOT NULL,
  `nume3` varchar(255) NOT NULL,
  `email3` varchar(255) NOT NULL,
  `telefon3` varchar(20) NOT NULL,
  `facebook3` varchar(255) NOT NULL,
  `marime_tricou3` varchar(20) NOT NULL,
  `nume4` varchar(255) NOT NULL,
  `email4` varchar(255) NOT NULL,
  `telefon4` varchar(20) NOT NULL,
  `facebook4` varchar(255) NOT NULL,
  `marime_tricou4` varchar(20) NOT NULL,
